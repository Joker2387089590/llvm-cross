...
#function apt_install_llvm {
 #   wget -O - https://apt.llvm.org/llvm-snapshot.gpg.key | sudo apt-key add -
  #  sudo apt install clang-14 lldb-14 lld-14 llvm-14 llvm-14-dev llvm-14-runtime clang-tools-14 libclang-14-dev clangd-14 libc++-14-dev libc++abi-14-dev libunwind-14-dev python3-clang-14 libclang1-14
#}
